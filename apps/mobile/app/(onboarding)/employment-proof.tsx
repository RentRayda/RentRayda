  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#F0F2F5' }}>
      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={{ paddingHorizontal: 20, paddingBottom: 32 }}>
        {/* Progress bar */}
        <Text style={{ fontSize: 12, fontFamily: 'NotoSansOsage', color: '#65676B', marginBottom: 4 }}>Step 2 of 2</Text>
        ...
        {/* Instructions */}
        <Text style={{ fontSize: 16, fontFamily: 'NotoSansOsage', color: '#65676B', marginBottom: 20, lineHeight: 24 }}>
        ...
        {isUploading && (
          <View style={{ marginTop: 16 }}>
            <Text style={{ fontSize: 14, fontFamily: 'NotoSansOsage', color: '#65676B', marginBottom: 8 }}>Uploading...</Text>
        ...
        <View style={{ marginTop: 12, backgroundColor: '#FFFBEB', borderRadius: 8, padding: 12, borderWidth: 1, borderColor: '#FDE68A' }}>
          <Text style={{ fontSize: 12, fontFamily: 'NotoSansOsage', color: '#92400E', lineHeight: 18 }}>
