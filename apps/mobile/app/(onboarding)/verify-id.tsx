...
export default function GovernmentIDUploadScreen() {
    ...
    return (
      <SafeAreaView style={{ flex: 1, backgroundColor: '#F0F2F5' }}>
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', paddingHorizontal: 20 }}>
          ...
          >
            <Text style={{ color: '#FFFFFF', fontFamily: 'NotoSansOsage', fontSize: 32 }}>✓</Text>
          </View>
          <Text style={{ fontSize: 20, fontFamily: 'TANNimbus', color: '#050505', textAlign: 'center' }}>
            Uploaded!
          </Text>
          <Text style={{ fontSize: 16, fontFamily: 'NotoSansOsage', color: '#65676B', textAlign: 'center', marginTop: 8 }}>
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#F0F2F5' }}>
      ...
      >
        {/* Progress bar */}
        <Text style={{ fontSize: 12, fontFamily: 'NotoSansOsage', color: '#65676B', marginBottom: 4 }}>Step 1 of 3</Text>
        ...
        >
          ...
          {infoExpanded && (
            <Text style={{ fontSize: 14, fontFamily: 'NotoSansOsage', color: '#65676B', marginTop: 8 }}>
        ...
        >
          ...
          >
            {consentChecked && (
              <Text style={{ color: '#FFFFFF', fontFamily: 'NotoSansOsage', fontSize: 12 }}>✓</Text>
            )}
          </View>
          <Text style={{ fontSize: 14, fontFamily: 'NotoSansOsage', color: '#65676B', flex: 1 }}>
        ...
        {idPhotoUri && (
          <View style={{ flexDirection: 'row', gap: 16, marginBottom: 16, alignItems: 'center' }}>
            ...
            <Pressable onPress={handleTakeIdPhoto}>
              <Text style={{ fontSize: 14, fontFamily: 'NotoSansOsage', color: '#2563EB' }}>Retake</Text>
            </Pressable>
          </View>
        )}
        ...
        {(isUploading || isSubmitting) && (
          <View style={{ marginTop: 16 }}>
            <Text style={{ fontSize: 14, fontFamily: 'NotoSansOsage', color: '#65676B', marginBottom: 8 }}>
        ...
        {uploadError && (
          <Pressable onPress={idObjectKey ? handleTakeSelfie : handleTakeIdPhoto}>
            <Text style={{ fontSize: 14, fontFamily: 'NotoSansOsage', color: '#E41E3F', textAlign: 'center', marginTop: 16 }}>
        ...
        >
          <Text style={{ fontSize: 14, fontFamily: 'NotoSansOsage', color: '#65676B', textDecorationLine: 'underline' }}>
