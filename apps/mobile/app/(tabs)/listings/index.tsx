  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#F0F2F5' }}>
      <View style={{ paddingHorizontal: 20, paddingTop: 16, paddingBottom: 8 }}>
        <Text style={{ fontSize: 20, fontFamily: 'TANNimbus', color: '#050505' }}>My Listings</Text>
      </View>

      {loading ? (
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
          <Text style={{ fontFamily: 'NotoSansOsage', color: '#65676B' }}>Loading...</Text>
        </View>
      ) : listings.length === 0 ? (
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', paddingHorizontal: 20 }}>
          <Text style={{ fontSize: 48, fontFamily: 'NotoSansOsage', marginBottom: 16 }}>H</Text>
          ...
          >
            <Text style={{ color: '#FFFFFF', fontFamily: 'NotoSansOsage', fontSize: 16 }}>CREATE A LISTING</Text>
          </Pressable>
        </View>
      ) : (
        <>
                ...
                >
                  <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <View style={{ paddingHorizontal: 8, paddingVertical: 2, borderRadius: 9999, backgroundColor: sc.bg }}>
                      <Text style={{ fontSize: 11, fontFamily: 'NotoSansOsage', color: sc.text }}>{item.status}</Text>
                    </View>
                  </View>
          ...
          <View style={{ paddingHorizontal: 20, paddingBottom: 16 }}>
            ...
            >
              <Text style={{ color: '#FFFFFF', fontFamily: 'NotoSansOsage', fontSize: 16 }}>+ CREATE NEW LISTING</Text>
            </Pressable>
          </View>
        </>
      )}
