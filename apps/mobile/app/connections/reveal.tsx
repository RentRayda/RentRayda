    ...
    return (
      <SafeAreaView style={{ flex: 1, backgroundColor: '#F0F2F5' }}>
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', paddingHorizontal: 20 }}>
          <Text style={{ fontSize: 16, fontFamily: 'NotoSansOsage', color: '#E41E3F', textAlign: 'center', marginBottom: 16 }}>
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#F0F2F5' }}>
      ...
      <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', paddingHorizontal: 24 }}>
        ...
        >
          <Text style={{ fontSize: 24, fontFamily: 'NotoSansOsage', color: '#2563EB' }}>Connected</Text>
        </Animated.View>

        {/* Headline */}
        <Text style={{ fontSize: 32, fontFamily: 'TANNimbus', color: '#2563EB', marginTop: 24, textAlign: 'center' }}>
          You are now connected!
        </Text>

        <Text style={{ fontSize: 16, fontFamily: 'NotoSansOsage', color: '#65676B', textAlign: 'center', marginTop: 16, paddingHorizontal: 24 }}>
        ...
        <View style={{ backgroundColor: '#DBEAFE', borderRadius: 16, padding: 20, width: '100%', marginTop: 32 }}>
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
            <View style={{ width: 56, height: 56, borderRadius: 28, backgroundColor: '#CED0D4', alignItems: 'center', justifyContent: 'center' }}>
              <Text style={{ fontSize: 24, fontFamily: 'NotoSansOsage', color: '#65676B' }}>P</Text>
            </View>
            <View style={{ flex: 1 }}>
              <Text style={{ fontSize: 18, fontFamily: 'NotoSansOsage', color: '#050505' }}>
          ...
          <Text style={{ fontSize: 24, fontFamily: 'NotoSansOsage', color: '#2563EB', marginTop: 16, textAlign: 'center' }}>
          ...
          <View style={{ flexDirection: 'row', gap: 12, marginTop: 16 }}>
            ...
            >
              <Text style={{ color: '#FFFFFF', fontFamily: 'NotoSansOsage', fontSize: 14 }}>Call</Text>
            </Pressable>
            <Pressable
              onPress={handleCopy}
              style={{ flex: 1, height: 48, borderWidth: 1, borderColor: '#2563EB', borderRadius: 8, alignItems: 'center', justifyContent: 'center' }}
            >
              <Text style={{ color: '#2563EB', fontFamily: 'NotoSansOsage', fontSize: 14 }}>
                {copied ? 'Copied!' : 'Copy'}
              </Text>
            </Pressable>
          </View>
        ...
        >
          <Text style={{ color: '#2563EB', fontFamily: 'NotoSansOsage', fontSize: 14 }}>Share with friends</Text>
        </Pressable>
      ...
      {copied && (
        <View style={{ position: 'absolute', bottom: 100, left: 20, right: 20, backgroundColor: '#31A24C', borderRadius: 8, padding: 12, alignItems: 'center' }}>
          <Text style={{ color: '#FFFFFF', fontFamily: 'NotoSansOsage' }}>Number copied!</Text>
        </View>
      )}
    </SafeAreaView>
  );
