  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#FFFFFF' }}>
      ...
      <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 20, paddingTop: 16 }}>
        ...
        <Text style={{ fontSize: 20, fontWeight: '500', color: '#1A1A2E' }}>Report</Text>
        <View style={{ width: 32 }} />
      </View>

      <ScrollView style={{ flex: 1 }} contentContainerStyle={{ paddingHorizontal: 20, paddingTop: 24, paddingBottom: 32 }}>
        <Text style={{ fontSize: 16, fontWeight: '500', color: '#1A1A2E', marginBottom: 12 }}>
          What is the problem?
        </Text>
        ...
        {REPORT_TYPES.map((type) => (
          ...
          >
            <View style={{ width: 20, height: 20, borderRadius: 10, borderWidth: 2, borderColor: reportType === type.value ? '#DC2626' : '#D1D5DB', alignItems: 'center', justifyContent: 'center' }}>
        ...
        {/* Description */}
        <Text style={{ fontSize: 16, fontWeight: '500', color: '#1A1A2E', marginTop: 16, marginBottom: 8 }}>
          Details (optional)
        </Text>
        <TextInput
          style={{
        ...
        {error && (
          <Text style={{ fontSize: 14, color: '#DC2626', textAlign: 'center', marginTop: 12 }}>{error}</Text>
        )}
        ...
        <Pressable
          ...
          style={{
            marginTop: 24, width: '100%', height: 48, backgroundColor: '#DC2626',
