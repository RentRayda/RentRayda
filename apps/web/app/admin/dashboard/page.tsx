...
function MetricCard({ value, label, color }: { value: number; label: string; color?: string }) {
  return (
    <div style={{
      ...
      <p style={{ fontSize: 36, fontWeight: 700, color: color || '#050505', margin: '0 0 4px', fontFamily: 'BerlinSansFB' }}>
  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 32 }}>
        <h1 style={{ fontSize: 24, fontWeight: 600, color: '#050505', margin: 0, fontFamily: 'BerlinSansFB' }}>Dashboard</h1>
        <button
      ...
      {/* Users */}
      <h2 style={{ fontSize: 14, fontWeight: 500, color: '#65676B', letterSpacing: 1, marginBottom: 12, fontFamily: 'BerlinSansFB' }}>USERS</h2>
      ...
      {/* Listings */}
      <h2 style={{ fontSize: 14, fontWeight: 500, color: '#65676B', letterSpacing: 1, marginBottom: 12, fontFamily: 'BerlinSansFB' }}>LISTINGS</h2>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: 16, marginBottom: 32 }}>
      ...
      {/* Connections */}
      <h2 style={{ fontSize: 14, fontWeight: 500, color: '#65676B', letterSpacing: 1, marginBottom: 12, fontFamily: 'BerlinSansFB' }}>CONNECTIONS</h2>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: 16, marginBottom: 32 }}>
      ...
      {/* Reports */}
      <h2 style={{ fontSize: 14, fontWeight: 500, color: '#65676B', letterSpacing: 1, marginBottom: 12, fontFamily: 'BerlinSansFB' }}>REPORTS</h2>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: 16, marginBottom: 32 }}>
